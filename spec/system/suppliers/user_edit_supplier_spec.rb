...
describe 'Usuário edita um fornecedor' do
    it 'a partir da página de detalhes' do
        #Arran
        supplier = Supplier.create!(corporate_name: 'ACME LTDA', brand_name: 'ACME', registration_number:'4343430000000', full_address: 'Av das Palmas, 100', city: 'Bauru', state: 'SP', email: 'contato@acme.com')
        ...
        expect(page).to have_field('CNPJ', with: '4343430000000')
