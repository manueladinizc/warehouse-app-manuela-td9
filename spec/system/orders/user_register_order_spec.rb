...
describe 'Usuário cadastra um pedido' do
    ...
    it'com sucesso' do
        ...
        allow(SecureRandom).to receive(:alphanumeric).with(10).and_return('ABC1234500') 
        #Act
        login_as(user)
        visit root_path
        click_on 'Registrar Pedido'
        ...
        expect(page).to have_content 'Pedido ABC1234500'
    ...
    it'e não informa a data de entrega' do
        ...
        supplier = Supplier.create!(corporate_name: 'ACME LTDA', brand_name: 'ACME', registration_number:'8887427100013', full_address: 'Av da Lagoa, 150', city: 'Bauru', state: 'SP', email: 'contato@acme.com')
