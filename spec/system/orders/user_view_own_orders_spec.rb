...
describe 'Usuário vê seus priprios pedidos' do
 ...
 it 'e vê itens do pedido' do
  ...
  product_a = ProductModel.create!(name: 'Produto A', weight: 15, width: 10, height: 20, depth: 30, supplier: supplier, sku: 'PTA-2022-41258796321' )
  product_b = ProductModel.create!(name: 'Produto B', weight: 15, width: 10, height: 20, depth: 30, supplier: supplier, sku: 'PTB-2022-41258796321' )
  product_c = ProductModel.create!(name: 'Produto C', weight: 15, width: 10, height: 20, depth: 30, supplier: supplier, sku: 'PTC-2022-41258796321' )
